...
class RoomConsumer(AsyncWebsocketConsumer):
	...
	async def disconnect(self, close_code):
		self.room.player.user.status = "ONLINE"
		await sync_to_async(self.room.player.user.save)()
