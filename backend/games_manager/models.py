...
class TwoPlayersGame (models.Model):	
	player1 = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='two_user_1')
	player2 = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='two_user_2')
