...
class TournamentRoom(models.Model):
	...
	players = models.ManyToManyField(MyUser, related_name='tournaments')
...
class TournamentStat(models.Model):
	...
	winner = models.ForeignKey(MyUser, on_delete=models.CASCADE, related_name='won_tournaments', null=True, blank=True)
	losers = models.ManyToManyField(MyUser, related_name='lost_tournaments')
