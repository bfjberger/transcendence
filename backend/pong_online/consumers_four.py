...
class RoomConsumerFour(AsyncWebsocketConsumer):
	...
	async def start_game(self):
		...
		await sync_to_async(self.game_state_obj.game_history.add_player)(self.game_state_obj.players['player_top'].player_model)
		await sync_to_async(self.game_state_obj.game_history.add_player)(self.game_state_obj.players['player_bottom'].player_model)
